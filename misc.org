#+PROPERTY: header-args:emacs-lisp :tangle ./misc-test.el
...
- [[#hooks][Hooks]]
- [[#sane-text-wrapping][Sane text wrapping]]
...
This does the opposite of what I would think.
#+begin_src emacs-lisp
(setq-default mini-modeline-enhance-visual nil) 
#+end_src

...
#+begin_src emacs-lisp :tangle ~/.emacs.d/config/3-keybinds.el
  ...
  ; (evil-define-key '(normal visual emacs) 'global (kbd "SPC a") "applicaitions")
  ; (define-key evil-normal-state-map "SPC a" 'evil-previous-visual-line)
  ...
  (evil-define-key '(normal visual emacs) 'global
    (kbd "SPC a") '("applications" . applications-map))
  (defalias 'applications-map

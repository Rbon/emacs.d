...
#+begin_src emacs-lisp :tangle ~/.emacs.d/config/elfeed.el
  (with-eval-after-load 'elfeed
    (rbon-define-key 'elfeed-search-mode '(normal)
      ...
      '("t u" ("unread" . rbon-elfeed-set-tags-unread))
      '("t a" ("all" . rbon-elfeed-set-tags-none))
      '("t v" ("vtuber" . rbon-elfeed-set-tags-vtuber))
      '("t V" ("not vtuber" . rbon-elfeed-set-tags-no-vtuber))
      '("T w" ("week" . rbon-elfeed-set-timeframe-one-week))
      '("T m" ("month" . rbon-elfeed-set-timeframe-one-month))
...
#+begin_src emacs-lisp :tangle ~/.emacs.d/config/elfeed.el
  (defun rbon-elfeed-search-update ()
    (setq elfeed-search-filter (concat
                                rbon-elfeed-timeframe " " rbon-elfeed-tags))
  ...
  (defun rbon-elfeed-set-tags-unread ()
    (interactive)
    (setq rbon-elfeed-tags "+unread")
    (rbon-elfeed-search-update))

  (defun rbon-elfeed-set-tags-none ()
    (interactive)
    (setq rbon-elfeed-tags "")
    (rbon-elfeed-search-update))

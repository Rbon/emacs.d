...
** Keybinds
I have found a bug in =rbon-define-key=. I cannot set the second argument to ='(normal visual)=. I suspect this has something to do with it being a local bind.
#+begin_src emacs-lisp :tangle ~/.emacs.d/keybinds.el
...
#  LocalWords:  Keybinds babel Org Misc Magit Dired Recentf

...
#+begin_src emacs-lisp :tangle ~/.emacs.d/config/org.el
  ...
  (defun my-thing ()
    (defalias 'user-org-mode-map (make-sparse-keymap))
    (evil-local-set-key 'normal
      (kbd "SPC n") '("narrow" . user-org-mode-map))
    (define-key 'user-org-mode-map (kbd "t") '("narrow to subtree" . org-narrow-to-subtree))
    )
